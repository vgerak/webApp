...
public class BVCatalog { 
	...
	public BVCatalog(){
		...
		/**Some content - we NOW populate with some objects!!*/
		addV(new VehicleBean("Buick","General Motors","1948",new MotorBean("2000", "V12", "620")));	
		addV(new VehicleBean("Mustang","Ford","1960",new MotorBean("4000", "V8", "400")));	
		addV(new VehicleBean("4CV","Citroen","1950",new MotorBean("1600", "6", "110")));	        
		addV(new VehicleBean("Jeep","General Motors", "1942",new MotorBean("1800", "4", "100")));
		addV(new VehicleBean("Beatle","Volkswagen","1938",new MotorBean("5000", "V6", "380")));       	             	
	}	
